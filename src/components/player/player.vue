                ...
                <div class="bottom">
                    ...
                    <div class="progress-wrapper">
                        ...
                        <div class="progress-bar-wrapper">
                            <porgress-bar :percent="percent" @percentChange="onProgressBarChange"></porgress-bar>
                        </div>
...
import PorgressBar from 'base/progress-bar/progress-bar'
...
export default {
    ...
    methods: {
        ...
        onProgressBarChange(percentt) {
            const currentTime = this.currentSong.duration * percentt
        ...
        formatTime(interval) {
            interval = interval | 0 // 相当于Math.floor 向下取整
